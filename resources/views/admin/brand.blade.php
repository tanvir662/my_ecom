...
<a href="{{url('admin/brand/manage_brand')}}"><button type="button" class="btn btn-info">Add Brand</button></a>
            ...
            <table class="table table-borderless table-data3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @endif
                        <td>
                            <a href="{{url('admin/brand/manage_brand/')}}/{{$list->id}}"><button type="button" class="btn btn-warning">Edit</button></a>
                            ...
                            <a href="{{url('admin/brand/status/1')}}/{{$list->id}}"><button type="button" class="btn btn-outline-primary">Deactive</button></a>
                            @endif
                        </td>
